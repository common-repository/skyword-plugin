		...
		if ( ! $user_id ) {
			...
			if ( ! $user_id ) {
				if ( null !== $coauthors_plus ) {
                    ...
                    return new IXR_Error( 500, __( 'User cannot be created, ensure new user creation is enabled in both Skyword and WordPress or use the Co-Authors Plus plugin.' ) );
			}
